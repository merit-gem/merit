...
6. Configure reputation rules for your application:
   * Configure +app/models/merit_badge_rules.rb+ for badges rules
   * Configure +app/models/merit_point_rules.rb+ for points rules
   * Configure +app/models/merit_rank_rules.rb+ for rank rules
