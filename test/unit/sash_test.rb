...
class SashTest < ActiveSupport::TestCase
  ...
  describe "#add_points" do
    ...
    it "should create a new point" do
      before = Merit::Score::Point.count
      @sash.add_points 5
      after = Merit::Score::Point.count
      s = Merit::Score.last
      p = s.score_points.last
  ...
  describe "#all_points" do
    ...
    it "should give the total number from points of all categories" do
      @sash.add_points 5, 'log-a-rythm', 'cat-et-gory'
      @sash.add_points 7
      
      assert_equal 7, @sash.points
      assert_equal 5, @sash.points('cat-et-gory')
      
      assert_equal 12, @sash.all_points
    end
